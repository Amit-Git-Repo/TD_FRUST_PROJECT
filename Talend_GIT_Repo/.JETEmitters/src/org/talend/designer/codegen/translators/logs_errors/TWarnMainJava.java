...
public class TWarnMainJava
{
  ...
  protected final String TEXT_51 = ") {" + NL + "\tlogIgnoredError(String.format(\"";
  protected final String TEXT_52 = " - tWarn failed to log message due to internal error: %s\", e_";
  protected final String TEXT_53 = "), e_";
